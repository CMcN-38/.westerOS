  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      hl.on("hyprland.start", function()
          ...
          hl.exec_cmd("swaybg -i /home/cameron/.themes/current/background")
          hl.exec_cmd("hypridle")
          hl.exec_cmd("thunar --daemon")
          hl.exec_cmd("goxlr-daemon --http-disable")
          hl.exec_cmd("emacs --daemon")
          hl.exec_cmd("solaar -w hide")
          hl.exec_cmd(terminal)
          hl.exec_cmd(browser)
          hl.exec_cmd("westerOS_launch_cider")
      ...
      hl.window_rule({ match = { class = "thunar" },              float = true, center = true, size = "60% 50%" })
      ...
      hl.window_rule({ match = { title = "^(Picture-in-Picture)$" }, float = true, pin = true, move = "1400 1000", size = "500 250" })
      ...
      hl.window_rule({ match = { class = "^(proton-mail)$" },         workspace = 4 })
      ...
      hl.window_rule({ match = { class = "^(Emacs)$" },           opacity = 0.90 })
      ...
      -- Gestures
      hl.gesture({ fingers = 3, direction = "horizontal", scale = 0.4, action = "workspace" })
      ...
      hl.bind(mainMod .. " + C",      hl.dsp.exec_cmd("westerOS_launch_cider"))
      hl.bind(mainMod .. " + D",      hl.dsp.exec_cmd("discordptb"))
      hl.bind(mainMod .. " + I",      hl.dsp.exec_cmd("westerOS_launch_iptv"))
      ...
      -- Battery saver
      hl.bind(mainMod .. " + SHIFT + B", hl.dsp.exec_cmd("westerOS_battery_saver_toggle"))
      ...
      listener = [
        {
          timeout = 1500;
          on-timeout = "hyprlock";
          condition_cmd = "! westerOS_check_audio";
          condition_retry = 30;
        }
        {
          timeout = 1800;
