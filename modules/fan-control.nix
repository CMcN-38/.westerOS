        ...
        speedCurve = [
          {
            temp = 0;
            speed = 0;
          } # Idle: Completely silent (0%)
          {
            temp = 45;
            speed = 0;
          } # Light use: Still silent
          {
            temp = 55;
            speed = 15;
          } # Warming up: Barely audible
          {
            temp = 65;
            speed = 25;
          } # Medium load: Low speed
          {
            temp = 70;
            speed = 45;
          } # Getting hot: Start ramping
          {
            temp = 75;
            speed = 70;
          } # Heavy load: Aggressive cooling
          {
            temp = 80;
            speed = 90;
          } # Very hot: Near max
          {
            temp = 85;
            speed = 100;
          } # Max: Full blast to prevent throttling
        ];
